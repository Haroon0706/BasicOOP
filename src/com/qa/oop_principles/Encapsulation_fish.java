...
public class Encapsulation_fish {
...
// Using custom methods we can add specifications to our data type
		 ...
		 * @param edible
		 */
		public Encapsulation_fish(String colour, String type, int size, int weight, int numberOfFins, boolean edible) {
			super();
			this.colour = colour;
			this.type = type;
			this.size = size;
		...
		// Getters and setters - Get data and set data through Source > Generate Getters/Setters
		...
		//	Booleans don't GET data, they are data, that is why "is" instead of "get" 
